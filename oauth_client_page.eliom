...
(* FIXME MOBILE *)
let%server css_name = !Oauth_client_config.css_name
...
(* FIXME MOBILE *)
let%server app_js = [Oauth_client_base.App.application_script ~defer:true ()]
let%client app_js = []
...
module Page_config = struct
  ...
  let default_error_page _ _ exn =
    Oauth_client_container.page None
