...
let%server () =
  ...
  let registerDemo (module D : DemoPage) =  Oauth_client_base.App.register
    ~service:D.service
    (Oauth_client_page.Opt.connected_page @@ demo_page D.page)
  in List.iter registerDemo demos;
  Oauth_client_base.App.register
    ~service:Oauth_client_services.otdemo_service
    (Oauth_client_page.Opt.connected_page handler)
